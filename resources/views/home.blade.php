...
<body class="home-gradient-bg">
    <div class="container ">
        <div class="d-flex justify-content-between my-5">
            ...
            <div>
                <a class="btn btn-success btn-rounded mr-5" href="{{ url('login') }}/">Se connecter </a>
                {{-- <a class="btn btn-warning btn-rounded"
                    href="https://themicly.github.io/Radmin-Laravel-Admin-Starter-Kit/">Documentation</a> --}}
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="my-5">
                <p class="text-center">Besoin d'aide ? Contactez-nous sur les liens en dessous</p>
