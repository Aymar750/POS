    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Catégories') }}</h5>
                            <span>Ajouter, supprimer ou modifier des catégories de produits</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="d-block d-md-inline-block">
                            <div class="btn-group float-md-left mr-1 mb-1">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="#">{{ __('CROI') }}</a>
                                </div>
                            </div>
                                ...
                                <form action="">
                                    ...
                                    <div class="adv-search-wrap dropdown-menu dropdown-menu-right"
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Titre de la catégorie">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Code de catégorie">
                                        </div>
                                        <button class="btn btn-theme">{{ __('Recherche') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="float-md-right">
                            <span class="text-muted text-small mr-2">{{ __('Affichage de 1 à 10 sur 210 éléments') }}
                            </span>
                            <button class="btn btn-outline-dark btn-xs dropdown-toggle" type="button"
                                ...
                                <div class="d-flex flex-grow-1 min-width-zero card-content">
                                    <div
                                        ...
                                        <p class="mb-1 w-15 w-xs-100">
                                            Total {{ $category['items'] }} Articles
                                        </p>
                                    </div>
                                    <div class="list-actions">
                                        <a href="#categoryView" data-toggle="modal" data-target="#categoryView"><i
            ...
            <div class="modal-dialog w-300" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="d-block">Catégorie Image</label>
                            <input type="file" name="category_image" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="d-block">Titre de la catégorie</label>
                            <input type="text" name="category_title" class="form-control"
                                placeholder="Enter Category Title">
                        </div>
                        <div class="form-group">
                            <label class="d-block">Code de catégorie</label>
                            <input type="text" name="category_code" class="form-control"
                                placeholder="Enter Category Code">
                        </div>
                        <div class="form-group">
                            <label class="d-block">Catégorie Parentale</label>
                            <select class="form-control select2 ">
                                <option selected="selected" value="" data-select2-id="3">Choisir une catégorie
                                </option>
        ...
        <div class="modal fade edit-layout-modal pr-0 " id="categoryView" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog w-300" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="categoryViewLabel">{{ __('Modifier la catégorie') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="d-block">>Image Categories</label>
                            <input type="file" name="category_image" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="d-block">Titre de la catégorie</label>
