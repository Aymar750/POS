            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Produits</h5>
                            <span>Afficher, supprimer et mettre à jour des produits</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header row">
                        <div class="col col-sm-2">
                            <a href="{{ url('products/create') }}" class="btn btn-sm btn-primary btn-rounded">Ajouter
                                Produit</a>
                        </div>
                            ...
                            <div class="card-options d-inline-block">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left" aria-labelledby="moreDropdown">
                                        ...
                                        <a class="dropdown-item" href="#">plus options</a>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control column_filter"
                                                        id="col0_filter" placeholder="Titre" data-column="0">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control column_filter"
                                                        id="col1_filter" placeholder="Prix" data-column="1">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control column_filter"
                                                        id="col2_filter" placeholder="Clé" data-column="2">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control column_filter"
                                                        id="col3_filter" placeholder="Qté" data-column="3">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control column_filter"
                                                        id="col4_filter" placeholder="Categorie" data-column="4">
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-4">
                                                <div class="form-group">
                        ...
                        <table id="advanced_table" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>50</td>
                                    <td>
                                        <a href="#productView" data-toggle="modal" data-target="#productView"><i
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <p>Apple iPhone 6 smartphone. Announced Sep 2014. Features 4.7″ display, Apple A8 chipset, 8 MP
                                primary camera, 1.2 MP front camera, 1810 mAh</p>
                            <p>In Stock: 100</p>
                            <p>Spplier: PZ Tech</p>
                        </div>
                    </div>
