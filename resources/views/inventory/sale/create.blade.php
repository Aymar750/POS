                                        ...
                                        <div class="row">
                                            <div class="col-sm-10 pr-0">
                                                ...
                                                <select class="form-control select2">
                                                    <option selected="selected" value="" data-select2-id="3">Select
                                                        Customer</option>
                                            ...
                                            <div class="col-sm-2 pl-1 pt-1">
                                                <button type="button" class="mt-4 btn btn-sm btn-primary"
                                                    data-toggle="modal" data-target="#CustomerAdd">+</button>
                                            </div>
                                    ...
                                    <div class="salestable">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1.</td>
                                                    <td> <img src="../img/widget/p1.jpg" alt=""
                                                            class="img-fluid img-20"> HeadPhone</td>
                                                    <td>$ 10.00</td>
                                                    <td><input type="text" name="shiping"
                                                            class="form-control w-60 text-center hm-30" value="5">
                                                    </td>
                                                    <td class="text-right">$ 50.00</td>
                                                </tr>
                                                <tr>
                                                    <td>2.</td>
                                                    <td> <img src="../img/widget/p2.jpg" alt=""
                                                            class="img-fluid img-20"> Iphone 6</td>
                                                    <td>$ 570.00</td>
                                                    <td><input type="text" name="shiping"
                                                            class="form-control w-60 text-center hm-30" value="1">
                                                    </td>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pay"
                                                    class="form-control text-center  ml-auto" value=""
                                                    placeholder="Amount">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="pt-4 text-right">
                                                <div type="button" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#InvoiceModal">Preview Invoice</div>
