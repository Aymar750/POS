                        ...
                        <form class="forms-sample" method="POST" action="{{ url('user/update') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Attribuer un rôle et afficher les autorisations du rôle -->

                                    <div class="form-group">
                                        <label for="role">{{ __('Attribuer un rôle') }}<span
                                        ...
                                        <div id="permission" class="form-group">
                                            @foreach ($user->getAllPermissions() as $key => $permission)
                                                <span class="badge badge-dark m-1">
                                                    ...
                                                    <!-- Nettoyer les données non échappées consiste à éviter le risque potentiel XSS -->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit"
                                            class="btn btn-primary form-control-right">{{ __('Modifier') }}</button>
                                    </div>
                                </div>
                            </div>
